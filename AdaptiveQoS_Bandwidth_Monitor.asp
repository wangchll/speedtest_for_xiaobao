...
if(code == ""){
code = "<tr><td colspan='3' style='text-align:center;color:#FFCC00'><div style='padding:5px 0px;border-top:solid 1px #333;'><#792#></div></td></tr>"; /*No Traffic in the list*/
}
$(apps_field).empty();
...
<tr>
<td>
<div class="formfonttitle" style="margin-bottom:0px;margin-left:50px;" title="<#789#>"><#791#></div>
</td>
<td >
...
<div style="margin:-10px 0 5px 70px;font-size:16px;text-align:center;"><#1960#></div>
...
<td id="download_unit">
<div style="margin:-10px 0 5px -55px;font-size:16px;text-align:center;"><#968#></div>
...
<table>
<tr>
<td><div style="width:110px;"><#1749#></div></td>
</tr>
</table>
</div>
</td>
...
<table>
<tr>
<td><div style="width:73px;"><#1018#></div></td>
</tr>
</table>
</div>
</td>
...
<div style="margin: 60px 0 0px 500px;"><a style="text-decoration:underline;" href="http://www.asus.com/support/FAQ/1008717/" target="_blank"><#793#> FAQ</a></div>
</td>
</tr>
</table>
</td>
